...
if(keyDown("r")){
  ...
  tom.addAnimation("catSleeping" , tomSleep);
  tom.changeAnimation("catSleeping");
  tom.x = 550;

  jerry.addAnimation("mouseEating" , jerryEating);
  jerry.changeAnimation("mouseEating");
  ...
  if(tom.isTouching(jerry)){
   ...
   fill("black");
   textSize(15);
   text("Press R to watch Again", 240, 200);
